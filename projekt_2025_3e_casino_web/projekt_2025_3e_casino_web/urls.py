...
urlpatterns = [
    ...
    path('poker/hand/<int:hand_id>/ready/', views.player_ready, name='player_ready'),
    path('poker/hand/<int:hand_id>/advance-stage/', views.advance_stage, name='advance_stage'),
    path('poker/hand/<int:hand_id>/actions/', views.get_hand_actions, name='get_hand_actions'),
