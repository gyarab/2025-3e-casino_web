...
def seed_default_quests(apps, schema_editor):
    ...
    weekly_quests = [
        ...
        quest('Blackjack Boss', 'Win 12 Blackjack games', 'weekly', 'blackjack_wins', 12, 330, 1800),
...
def remove_seeded_quests(apps, schema_editor):
    Quest = apps.get_model('main', 'Quest')
    Quest.objects.filter(quest_type__in=['daily', 'weekly']).delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(seed_default_quests, remove_seeded_quests),
    ]
